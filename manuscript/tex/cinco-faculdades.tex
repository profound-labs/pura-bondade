...
% TODO more glossary style

\begin{itemize}

\item Fé (\emph{saddha}) -- fé em como vale a pena praticar, em como isso nos
  ajuda e nos leva onde queremos chegar. E igualmente importante, senão mais
...
\item Energia ou esforço (\emph{viriya}) -- quando temos fé, temos energia. Se
  nos desanimamos a nossa energia desaparece. Assim, é verdadeiramente
  importante sustentar a fé, de forma a suportar o esforço para nos aplicarmos
  no cultivo da consciência, \emph{sati}.

\item Consciência (\emph{sati}) -- \emph{sati} olha pelas outras faculdades e
  mantém-nas equilibradas.

\item Tranquilidade (\emph{samadhi}) -- esta reunião e concentração da atenção
  constitui uma forma de equilibrar a energia.

\item Discernimento sábio (\emph{pañña}) -- a discriminação cuidadosa pode
  equilibrar a fé.
